...
class _ImageDetailViewState extends State<ImageDetailView> {
          ...
          return WillPopScope(
            ...
            child: Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () => viewModel.showColorPickerDialog(context),
              ),
            ),
          );
        },
  ...
  Widget _buildUserInfo(ImageDetailViewModel viewModel) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: viewModel.selectedBackgroundColor),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          _buildProfileImage(user),
          const SizedBox(width: 6),
          Expanded(child: _buildUserTextDetails(user, viewModel)),
  ...
  Widget _buildUserTextDetails(
      Map<String, dynamic> user, ImageDetailViewModel viewModel) {
    return Column(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            fontSize: 13,
            color: viewModel.selectedTextColor.withOpacity(0.8),
            shadows: const [
              Shadow(
                offset: Offset(0, 1),
                blurRadius: 2,
        ...
        Text(user['designation'] ?? 'No designation',
            style: TextStyle(fontSize: 11, color: viewModel.selectedTextColor)),
